...
def classify():
    ...
    image_1 = "https://s3-ap-southeast-1.amazonaws.com/rblwg/images/image_" + '{:05d}'.format(image_1) + ".jpg"
    image_2 = "https://s3-ap-southeast-1.amazonaws.com/rblwg/images/image_" + '{:05d}'.format(image_2) + ".jpg"
